...
class LoraRadioEnergyModel : public EnergyModel {
public:
  static TypeId GetTypeId (void);
  LoraRadioEnergyModel ();
  virtual ~LoraRadioEnergyModel ();

  // Custom methods for LoraRadioEnergyModel
  void SetEnergySource (Ptr<EnergySource> source);
  double GetCurrentEnergyConsumption () const;

private:
  // Private attributes and methods
  Ptr<EnergySource> m_source;
  double m_currentEnergyConsumption;
};
